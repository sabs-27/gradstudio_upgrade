                            ...
                            if (activeCards.length > 0) {
                                ...
                                activeCards.forEach(card => {
                                    ...
                                    if (contentType === 'image' && card.image_url) {
                                        mediaHtml = `<div class="secondary-card-media"><img src="${card.image_url}" alt="${card.title}" style="width:100%; height:100%; object-fit:cover;" loading="lazy" decoding="async"></div>`;
